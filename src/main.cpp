...
int pins[]={27,26,25,33,32};//temporary middle pins until i fix the the IR sensors
...
//    rightMotor->SetPid(0.9,2.5,0);
//    leftMotor->SetPid(0.9,2.5,0);
